...
int main(int argc, char **argv, char **envp)
{
    ...
    printf("This challenge will randomly skip up to 0x800 bytes in your shellcode.\n");
    printf("You better adapt to that!\n");
    printf("\n");
    printf("One way to evade this is to have your shellcode start with a long set of\n");
    printf("single-byte instructions that do nothing, such as \"nop\", before the actual\n");
    printf("functionality of your code begins. When control flow hits any of these instructions,\n");
    printf("they will all harmlessly execute and then your real shellcode will run.\n");
    printf("\n");
    printf("This concept is called a \"nop sled\".\n");
