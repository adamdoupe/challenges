...
int main(int argc, char **argv, char **envp)
{
    ...
    printf("This challenge is just sorted your your shellcode using bubblesort.\n");
    printf("This sort processed your shellcode %d bytes at a time. Keep in mind\n", sizeof(uint64_t));
    printf("The impact of memory endianness on this sort (i.e., the LSB being the\n");
    printf("right-most byte.\n");
